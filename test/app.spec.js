...
describe('A calcTriangleArea() függvény tesztje', () => {
    ...
    it('Ha az alap 0, kivételt kapnunk megadott szöveggel', () => {
        expect(() => calcTriangleArea(0, 30)).toThrowError('Hiba! Az érték nem megfelelő!');
    });
    it('Ha az magasság 0, kivételt kapnunk', () => {
        expect(() => calcTriangleArea(30, 0)).toThrow();
    });
    it('Ha az magasság 0, kivételt kapnunk megadott szöveggel', () => {
        expect(() => calcTriangleArea(30, 0)).toThrowError('Hiba! Az érték nem megfelelő!');
    });
});
